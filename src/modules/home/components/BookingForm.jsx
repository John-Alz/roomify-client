...
export const BookingForm = () => {
  return (
    <div className="relative z-10 bg-white rounded-xl shadow-lg p-5 md:p-6 flex flex-wrap md:flex-nowrap items-center mx-auto mt-[-47px] space-y-4 md:space-y-0 md:space-x-4" style={{ width: '84%' }}>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 w-full items-center gap-4">
        {/* Habitación */}
        <div className="flex flex-col items-center md:items-start gap-2 w-full">
          ...
          <div className="flex flex-col w-full text-center md:text-left">
            ...
            <select className="bg-white text-gray-500 text-xs font-medium rounded-md border-gray-300 focus:outline-none p-1 sm:max-w-xs mx-auto md:mx-0">
        ...
        <div className="flex flex-col items-center md:items-start gap-2 w-full">
          ...
          <div className="flex flex-col w-full text-center md:text-left">
            ...
            <input
              type="date"
              className="bg-white text-gray-500 text-xs font-medium rounded-md border-gray-300 focus:outline-none p-1 sm:max-w-xs mx-auto md:mx-0"
            />
          </div>
        </div>
