...
export const Footer = () => {
  return (
    <footer className="bg-white px-6 text-gray-800 pb-8">
      ...
      <div className="bg-white container mx-auto flex justify-between items-center pt-4 mt-4 text-sm text-gray-800">
