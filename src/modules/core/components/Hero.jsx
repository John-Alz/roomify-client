...
export const Hero = ({ title, subtitle, image }) => {
  return (
    <div className="relative w-full">
      <div
        className="min-h-[410px] sm:min-h-[420px] md:min-h-[460px] lg:min-h-[500px] flex justify-center items-center px-4 bg-no-repeat bg-cover bg-center relative"
      ...
      >
        ...
        <div className="relative z-10 text-center text-white w-full max-w-3xl px-4">
          ...
          {subtitle && <p className="text-base sm:text-lg md:text-xl mt-4">{subtitle}</p>}
        </div>
      </div>
    </div>
  );
