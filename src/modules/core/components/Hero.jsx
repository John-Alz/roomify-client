...
export const Hero = ({ title, subtitle, image }) => {
  return (
    <div className="relative w-full">
      ...
      <div className={`bg-[url('${image}')] bg-no-repeat bg-cover bg-center min-h-[410px] sm:min-h-[420px] md:min-h-[460px] lg:min-h-[500px] flex justify-center items-center px-4`}>
